...
Welcome to `nextmv-ortools`, an SDK for integrating OR-Tools with the Nextmv
platform.

> [!IMPORTANT]  
> Please note that `nextmv-ortools` is provided as _source-available_ software
> (not _open-source_). For further information, please refer to the
> [LICENSE](./LICENSE.md) file.

📖 To learn more about the `nextmv-ortools`, visit the [docs][docs].
...
[docs]: https://nextmv-py.docs.nextmv.io/en/latest/nextmv-ortools/